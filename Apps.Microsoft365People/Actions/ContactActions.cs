using Apps.Microsoft365People.Invocables;
using Apps.Microsoft365People.Models.Contact.Dtos;
using Apps.Microsoft365People.Models.Contact.Requests;
using Apps.Microsoft365People.Models.Contact.Responses;
...
public class ContactActions(InvocationContext invocationContext) : AppInvocable(invocationContext)
{
    ...
    [Action("List contacts", Description = "List user's contacts.")]
    ...
    [Action("Get contact", Description = "Get a contact.")]
    ...
    [Action("Update contact", Description = "Update a contact.")]
    ...
    [Action("Add email to contact", Description = "Add email to emails list of a contact.")]
    public async Task<ContactDto> AddEmail(
        IEnumerable<AuthenticationCredentialsProvider> authenticationCredentialsProviders,
    ...
    [Action("Remove email from contact", Description = "Remove email from emails list of a contact.")]
    public async Task<ContactDto> RemoveEmail(
        IEnumerable<AuthenticationCredentialsProvider> authenticationCredentialsProviders,
        [ActionParameter] EmailRequest request)
    {
        var client = new MicrosoftOutlookClient(authenticationCredentialsProviders);
    ...
    [Action("Add business phone number", Description =
        "Add business phone number to business phones list of " +
        "a contact.")]
    public async Task<ContactDto> AddBusinessPhone(
        IEnumerable<AuthenticationCredentialsProvider> authenticationCredentialsProviders,
    ...
    [Action("Remove business phone number", Description =
        "Remove business phone number from business phones " +
        "list of a contact.")]
    public async Task<ContactDto> RemoveBusinessPhone(
        IEnumerable<AuthenticationCredentialsProvider> authenticationCredentialsProviders,
        [ActionParameter] BusinessPhoneRequest request)
    {
        var client = new MicrosoftOutlookClient(authenticationCredentialsProviders);
